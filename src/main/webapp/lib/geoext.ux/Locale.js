...
Local = {
    ...
    localizedStrings: {
        ...
        tWelcomeTextSubtitle: { en: 'Our map viewer contains a selection of digital maps (WMS) from environmental authorities of counties and countries. You have the choice: More than 200 digital maps are provided by us presented by topic and provider lists. More map services can be found by using the search function.', de: 'Unser Kartenviewer enth&auml;lt eine Auswahl digitaler Kartendienste (WMS) von Umweltbeh&ouml;rden aus Bund und L&auml;ndern. Sie haben die Wahl: Mehr als 200 digitale Karten stellen wir zur Zeit &uuml;ber die Themen- und Anbieterliste bereit. Weitere Kartendienste k&ouml;nnen Sie &uuml;ber die Suchmaske recherchieren.'},
