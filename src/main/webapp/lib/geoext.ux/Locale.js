...
Local = {
    ...
    localizedStrings: {
        ...
        tUmDerSucheEinenRaumbezugHinzuzufuegenBitteEineAuswahlTreffen: { en: '<p><strong>With the following actions you can pick a spatial reference to which the search results will be limited:</strong><br/><br/>' 
				...
				+'<strong>- "Gebiet ausw&auml;hlen"</strong> <img style="margin-bottom:-3px;border:0;" class="iconSelectCoordinates"/> : W&auml;hlen Sie ein Gebiet aus, welches r&auml;umlich die Suchergebnisse beschr&auml;nkt. Beachten Sie auch die Optionen unterhalb der Karte.<br/><br/>' 
