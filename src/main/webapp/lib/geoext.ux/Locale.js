...
Local = {
    ...
    localizedStrings: {
        ...
        tWelcomeTextAdd: { en: 'NOT_YET_TRANSLATED', de: 'a) L&auml;dt markierten Kartendienst in das Kartenfenster <br />b) Hinzuf&uuml;gen externer Kartendienste mithilfe der GetCapabilities-URL' },
        tWelcomeTextRemove: { en: 'NOT_YET_TRANSLATED', de: 'L&ouml;scht markierte Kartendienste unter Aktive Dienste aus der aktuellen Kartenansicht'},
        tWelcomeTextRemoveAll: { en: 'NOT_YET_TRANSLATED', de: 'L&ouml;scht die Ergebnisliste der Suchanfrage'},
        ...
        tWelcomeTextExpand: { en: 'NOT_YET_TRANSLATED', de: 'Klappt alle Layer eines Dienstes auf bzw. zu'},
        tWelcomeTextZoomLayerExtent: { en: 'NOT_YET_TRANSLATED', de: 'Zoomt auf Kartendienst oder Layer'},
        
        tWelcomeTextInfo: { en: 'NOT_YET_TRANSLATED', de: 'Zeigt Objektinformationen (Sachattribute) aller aktiven Layer an'},
        ...
        tWelcomeTextZoom: { en: 'NOT_YET_TRANSLATED', de: 'Zoomt auf die Originalgr&ouml;ße der Hintergrundkarte'},
        tWelcomeTextMeassure: { en: 'NOT_YET_TRANSLATED', de: 'Misst Entfernungen oder Fl&auml;chen auf der Karte'},
        
        tWelcomeTextPrint: { en: 'NOT_YET_TRANSLATED', de: 'Druckt den aktuellen Kartenausschnitt als PDF'},
        tWelcomeTextLoad: { en: 'NOT_YET_TRANSLATED', de: 'L&auml;dt zuvor gespeicherte Karten (PortalU-Nutzer-Login erforderlich)'},
        tWelcomeTextSave: { en: 'NOT_YET_TRANSLATED', de: 'Speichert die aktuelle Kartenansicht (PortalU-Nutzer-Login erforderlich)'},
        tWelcomeTextDownload: { en: 'NOT_YET_TRANSLATED', de: 'Speichert Karte als WMC (Web Map Context)'},
        tWelcomeTextTipp0: { en: 'NOT_YET_TRANSLATED', de: 'Sie wollen eine detailliertere Ansicht eines bestimmten Kartenbereichs? Mit gedr&uuml;ckter SHIFT- und linker Maustaste k&ouml;nnen Sie ein Zoom-Rechteck auf den gew&uuml;nschten Bereich aufziehen.'},
        tWelcomeTextTipp1: { en: 'NOT_YET_TRANSLATED', de: 'Mithilfe des roten Rechtecks im &Uuml;bersichtfenster unten rechts im Kartenviewer k&ouml;nnen Sie im aktuellen Kartenausschnitt navigieren. Alternativ k&ouml;nnen Sie auch mit gedr&uuml;ckter linker Maustaste den Ausschnitt im Kartenfenster verschieben.'},
        tWelcomeTextTipp2: { en: 'NOT_YET_TRANSLATED', de: 'Sie wollen eigene Kartendienste in unserem Kartenviewer visualisieren? <br/>Externe Kartendienste lassen sich &uuml;ber eine WMS-URL einbinden. Unterst&uuml;tzt werden die Standards 1.1.1 und 1.3.0. &Ouml;ffnen Sie mit dem   das Fenster Dienst hinzuf&uuml;gen und geben eine valide WMS-URL ein.'},
        tWelcomeTextTipp3: { en: 'NOT_YET_TRANSLATED', de: 'Sind haben einen Kartendienst (WMS) geladen, aber keine Informationen werden angezeigt? Die Informationen mancher Layer werden nur innerhalb eines bestimmten Maßstabbereichs gezeichnet. Maßstabsabh&auml;ngige Layer erkennen Sie an der ausgegrauten Farbgebung. &Auml;ndern Sie den Maßstab mithilfe des Navigation-Tools im Kartenfenster oder den Maßstabseinstellung unter "Erweiterten Einstellungen".'},
        tWelcomeTextTipp4: { en: 'NOT_YET_TRANSLATED', de: 'Sie suchen Karten zu einem bestimmten Umweltthema? Finden Sie eine passende Karte mit Hilfe der Suchfunktion unterhalb der Anbieter- und Themenliste. Mit der Suchanfrage werden s&auml;mtliche angeschlossene Kataloge aus Bund und L&auml;ndern nach passenden Kartendiensten (WMS) durchsucht.'},
        tWelcomeTextTipp5: { en: 'NOT_YET_TRANSLATED', de: 'Sie wollen eine Kartenansicht speichern und zu einem sp&auml;teren Zeitpunkt wieder aufrufen? Nutzen Sie die Vorteile eines pers&ouml;nlichen PortalU-Logins: Auf der Seite <a href="www.portalu.de/personalisierungsoptionen">Mein PortalU</a> k&ouml;nnen Sie sich als Benutzer registrieren. Damit stehen Ihnen eine Vielzahl von ...'},
        tWelcomeTextTitle: { en: 'NOT_YET_TRANSLATED', de: 'WILLKOMMEN BEIM KARTENVIEWER'},
        tWelcomeTextSubtitle: { en: 'NOT_YET_TRANSLATED', de: 'Unser Kartenviewer enth&auml;lt eine Auswahl digitaler Kartendienste (WMS) von Umweltbeh&ouml;rden aus Bund und L&auml;ndern. Sie haben die Wahl: Mehr als 200 digitale Karten stellen wir zur Zeit &uuml;ber die Themen- und Anbieterliste bereit. Weitere Kartendienste k&ouml;nnen Sie &uuml;ber die Suchmaske ercherchieren.'},
