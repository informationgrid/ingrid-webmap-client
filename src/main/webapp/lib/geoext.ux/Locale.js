...
Local = {
    ...
    localizedStrings: {
        ...
        tWelcomeTextAdd: { en: 'NOT_YET_TRANSLATED', de: 'a) L&auml;dt einen markierten Kartendienst aus der <strong>Anbieter-/Themenliste</strong> in den Viewer <br />b) L&auml;dt einen <strong>externen Kartendienst</strong> mithilfe der WMS-URL in den Viewer' },
        tWelcomeTextRemove: { en: 'NOT_YET_TRANSLATED', de: 'L&ouml;scht einen markierten Kartendienste in der Rubrik <strong>Aktive Dienste</strong> aus der aktuellen Kartenansicht'},
        ...
        tWelcomeTextTipp2: { en: 'NOT_YET_TRANSLATED', de: '<h1>Sie wollen eigene Kartendienste in unserem Kartenviewer visualisieren?</h1><p>Externe Kartendienste lassen sich &uuml;ber eine WMS-URL einbinden. Unterst&uuml;tzt werden die Standards 1.1.0, 1.1.1 und 1.3.0. &Ouml;ffnen Sie mit dem <span class="iconTable iconAdd" style="display: inline-block;"></span> das Fenster Dienst hinzuf&uuml;gen und geben eine valide WMS-URL ein.</p>'},
