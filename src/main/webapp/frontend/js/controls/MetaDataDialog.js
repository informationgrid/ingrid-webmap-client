 ...
 */
Ext.define('de.ingrid.mapclient.frontend.controls.MetaDataDialog', {
	extend: 'Ext.Window',
	cls: 'metadataDialog',
	...
	applyData: function(service) {
		...
		for( var i = 0; i < wmsServices.length; i++){
			...
			if(wmsService.capabilitiesUrl.split("?")[0] == service.capabilitiesUrl.split("?")[0]){
	 ...
	 * @returns String
	 */
	getServiceInfoHtml: function(data) {
	 ...
	 * @returns String
	 */
	getLayerInfoHtml: function(data) {
